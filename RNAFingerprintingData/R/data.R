.registry <- data.frame(
  ...
  package = c('gwps', 'B.cell.immune.dictionary', 'CD4.T.cell.immune.dictionary',
              ...
              'Mast.cell.immune.dictionary', 'MigDC.immune.dictionary',
  ...
  tarball = c('https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/gwps_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/B.cell.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/CD4.T.cell.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/CD8.T.cell.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/cDC1.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/cDC2.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/eTAC.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/ILC.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/Ki67.T.cell.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/Langerhans.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/LEC.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/Macrophage.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/Mast.cell.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/MigDC.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/Monocyte.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/NK.cell.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/pDC.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/Treg.immune.dictionary_0.0.0.9000.tar.gz',
              'https://github.com/satijalab/rna-fingerprinting-data/releases/download/v1/gd.T.cell.immune.dictionary_0.0.0.9000.tar.gz'),
